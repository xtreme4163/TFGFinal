...
# alh = SwarmPackagePy.pso(5, func.getMse, 0, 255, 3, 10, w=0.729, c1=2.05, c2=2.05)
                         
#Luciernagas
alh = SwarmPackagePy.fa(5, func.getMse, 0, 255, 3, 10, csi=1, psi=1, alpha0=1, alpha1=0.1, norm0=0, norm1=0.1)
